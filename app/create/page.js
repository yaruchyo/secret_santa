                    ...
                    <div className="flex items-center justify-between pt-8">
                        ...
                        {step < totalSteps ? (
                            <button
                                ...
                                className="flex items-center gap-2 bg-primary text-background-secondary px-6 py-3 rounded-xl font-bold hover:bg-primary-hover transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                            >
                            ...
                            <button
                                ...
                                className="flex items-center gap-2 bg-primary text-background-secondary px-8 py-3 rounded-xl font-bold hover:bg-primary-hover transition-colors disabled:opacity-50"
                            >
